...
#> [2022-10-26 17:11:56] Your object is bigger than 1 MB (5.75186157226562 MB). Uploading larger objects may take some time.
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (exists("DIS_DIAB", D_complete)) [----------------------------------------]   0% / 0s  Getting aggregate ds1 (exists("DIS_DIAB", D_complete)) [=======>-----------------------]  25% / 0s  Checking ds2 (exists("DIS_DIAB", D_complete)) [=========>------------------------------]  25% / 0s  Getting aggregate ds2 (exists("DIS_DIAB", D_complete)) [===============>---------------]  50% / 0s  Checking ds3 (exists("DIS_DIAB", D_complete)) [===================>--------------------]  50% / 0s  Getting aggregate ds3 (exists("DIS_DIAB", D_complete)) [======================>--------]  75% / 0s  Aggregated (exists("DIS_DIAB", D_complete)) [==========================================] 100% / 0s
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [--------------]   0% / 0s  Getting aggregate ds1 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [>----]  25% / 0s  Checking ds2 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [===>----------]  25% / 0s  Checking ds3 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [===>----------]  25% / 0s  Waiting...  (...) [================>---------------------------------------------------]  25% / 0s  Checking ds2 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [===>----------]  25% / 0s  Getting aggregate ds2 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [=>---]  50% / 0s  Checking ds3 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [======>-------]  50% / 1s  Waiting...  (...) [=================================>----------------------------------]  50% / 1s  Checking ds3 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [======>-------]  50% / 1s  Getting aggregate ds3 (l2sens("D_complete", "pred", 2292, "xXcols", diff, TRUE)) [===>-]  75% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> 
#> [2022-10-26 17:13:18] L2 sensitivity is: 0.0015
#> 
...
#> 
#> [2022-10-26 17:13:19] Setting: epsilon = 0.2 and delta = 0.1
#> 
#> 
#> [2022-10-26 17:13:19] Initializing ROC-GLM
#> 
#> [2022-10-26 17:13:19] Host: Received scores of negative response
#> 
#> [2022-10-26 17:13:19] Receiving negative scores
...
#> [2022-10-26 17:13:19] Host: Pushing pooled scores
...
#> [2022-10-26 17:13:20] Server: Calculating placement values and parts for ROC-GLM
...
#> [2022-10-26 17:13:21] Server: Calculating probit regression to obtain ROC-GLM
...
#> [2022-10-26 17:13:21] Deviance of iter1=38.8162
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  25% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-10-26 17:13:22] Deviance of iter2=48.9408
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  25% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-10-26 17:13:23] Deviance of iter3=52.5077
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  25% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-10-26 17:13:23] Deviance of iter4=52.5684
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  25% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-10-26 17:13:24] Deviance of iter5=52.5684
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  25% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-10-26 17:13:24] Deviance of iter6=52.5684
#> [2022-10-26 17:13:24] Host: Finished calculating ROC-GLM
#> [2022-10-26 17:13:24] Host: Cleaning data on server
#> [2022-10-26 17:13:25] Host: Calculating AUC and CI
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (internSum("truth")) [----------------------------------------------------]   0% / 0s  Getting aggregate ds1 (internSum("truth")) [==========>--------------------------------]  25% / 0s  Checking ds2 (internSum("truth")) [============>---------------------------------------]  25% / 0s  Getting aggregate ds2 (internSum("truth")) [=====================>---------------------]  50% / 0s  Checking ds3 (internSum("truth")) [=========================>--------------------------]  50% / 0s  Getting aggregate ds3 (internSum("truth")) [===============================>-----------]  75% / 0s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (internLength("truth")) [-------------------------------------------------]   0% / 0s  Getting aggregate ds1 (internLength("truth")) [=========>------------------------------]  25% / 0s  Checking ds2 (internLength("truth")) [===========>-------------------------------------]  25% / 0s  Getting aggregate ds2 (internLength("truth")) [===================>--------------------]  50% / 0s  Checking ds3 (internLength("truth")) [=======================>-------------------------]  50% / 0s  Getting aggregate ds3 (internLength("truth")) [=============================>----------]  75% / 0s  Aggregated (...) [=====================================================================] 100% / 1s
...
**Build by daniel (Linux) on 2022-10-26 17:13:31.**
